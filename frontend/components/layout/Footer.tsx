...
export function Footer() {
 ...
 return (
 <footer className="bg-white text-gray-600 border-t border-[var(--gold-100)] py-12 mt-auto print:hidden">
 <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
 <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
 {/* Brand Column */}
 <div className="space-y-4">
 <div className="flex items-center gap-2.5">
 <img src="/images/logo.png" alt="OM Astrology AMC Logo" className="w-8 h-8 object-contain border border-[var(--gold-200)] rounded-full bg-white shadow-md p-0.5" />
 ...
 {/* Quick Links Column */}
 <div>
 <h4 className="text-gray-900 text-sm font-semibold mb-4 tracking-wider uppercase">
 Quick Links
 </h4>
 ...
 <div className="border-t border-gray-200 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center text-xs">
 <p>
