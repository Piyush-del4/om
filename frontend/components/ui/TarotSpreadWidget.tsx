...
export function TarotSpreadWidget({ onSuitChange, activeSuit }: TarotSpreadWidgetProps) {
 ...
 <div className="flex-1 flex flex-col items-center justify-center bg-gray-50/40 border border-gray-200 rounded-3xl p-6 min-h-[450px] relative overflow-hidden">
 {/* Celtic Cross Grid */}
 {spread === 'celtic' ? (
 ...
 >
 <GoldCard className="border border-[var(--gold-300)] p-6 flex flex-col justify-between w-full relative overflow-hidden">
 ...
 <div className="w-full lg:w-[350px] flex-shrink-0 flex items-center justify-center border border-dashed border-gray-200 rounded-3xl p-6 text-center text-gray-500 text-xs font-light">
...
function TarotSlot({ slot, drawn, onDraw }: TarotSlotProps) {
 ...
 drawn?.revealed
 ? 'bg-gray-100 border border-[var(--gold-200)] shadow-lg shadow-[var(--gold-50)]/20'
 : 'border border-[var(--gold-100)]/30 bg-gray-50 shadow-md hover:border-[var(--gold-100)] shadow-black/50'
 }`}
 ...
 <div className="absolute inset-0 bg-gray-50 border-2 border-[var(--gold)] rounded-xl p-2 flex flex-col items-center justify-between select-none">
 ...
 <span className="text-[7px] text-gray-600 block tracking-wider uppercase opacity-80 leading-none">
 Click to draw
 </span>
 </div>
 </div>
