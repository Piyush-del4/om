...
export function VimshottariDashaTable({ data, dashaApiData, birthDateStr }: VimshottariDashaProps) {
 ...
 {/* Title Header */}
 <h3 className="text-xl md:text-2xl font-sans font-bold text-amber-950 text-center flex items-center justify-center gap-2">
 ✦ Mahadasha & Antardasha ✦
 </h3>

 {/* 1. Mahadasha Table */}
 <div className="pdf-page-break-avoid rounded-xl overflow-hidden bg-white mb-8">
 ...
 <thead>
 <tr className="bg-[#fef08a] text-amber-950 font-bold text-xs border-b border-amber-600">
 ...
 <tbody className="divide-y divide-amber-600/30 text-xs font-medium text-neutral-900 ">
 {displayTimeline.map((maha, mIdx) => (
 <tr key={mIdx} className="hover:bg-amber-200/40 transition-colors bg-amber-50/50 ">
 <td className="p-2 border-r border-amber-600/30 font-sans font-bold text-amber-950 ">
 {maha.lord.vedic}
 </td>
 ...
 {displayTimeline.map((maha, mIdx) => (
 <div key={`antar-${mIdx}`} className="pdf-page-break-avoid rounded-xl overflow-hidden bg-white ">
 <h4 className="bg-[#f59e0b] text-black font-bold text-center py-2 text-sm md:text-base border-b border-amber-600 font-sans">
 ...
 <tr key={`${maha.lord.vedic}-${aIdx}`} className="hover:bg-amber-200/40 transition-colors bg-amber-50/50 ">
 <td className="p-2 border-r border-amber-600/30 font-sans font-bold text-amber-800 ">
 {antar.lord.vedic}
 </td>
 <td className="p-2 border-r border-amber-600/30 font-mono text-[11px] sm:text-xs">
 {antar.startDateStr}
