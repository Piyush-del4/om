...
export function VimshottariDashaTable({ data, dashaApiData, birthDateStr }: VimshottariDashaProps) {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto my-6 space-y-6">
      ...
      {/* 1. Mahadasha Table */}
      <div className="pdf-page-break-avoid rounded-xl overflow-hidden bg-white dark:bg-neutral-900 mb-8">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {displayTimeline.map((maha, mIdx) => (
            <div key={`antar-${mIdx}`} className="pdf-page-break-avoid rounded-xl overflow-hidden bg-white dark:bg-neutral-900">
              <h4 className="bg-[#f59e0b] text-black font-bold text-center py-2 text-sm md:text-base border-b border-amber-600 font-sans">
