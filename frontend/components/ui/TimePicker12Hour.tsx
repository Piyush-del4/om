    ...
    <div className="flex items-center gap-2">
      ...
      <div className="relative flex-1">
        <select
          ...
          className="w-full bg-neutral-900 border border-neutral-800 rounded-lg px-3 py-3 text-white focus:outline-none focus:border-[var(--gold)] transition-colors text-sm appearance-none cursor-pointer"
        >
          {hours.map((h) => (
      ...
      <div className="flex rounded-lg border border-neutral-800 overflow-hidden bg-neutral-900 p-0.5">
        <button
          type="button"
