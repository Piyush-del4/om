...
export function PlanetsPositionTable({ data }: PlanetsTableProps) {
 ...
 return (
 <tr key={planet} className="hover:bg-amber-200/30 :bg-gray-200/40 transition-colors">
 ...
 <div className="text-xs sm:text-[13px] font-mono font-bold text-amber-900/90 mt-0.5">
