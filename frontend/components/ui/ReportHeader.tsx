...
export function ReportHeader({ className = '' }: ReportHeaderProps) {
 return (
 <div className={`w-full max-w-4xl mx-auto my-4 p-4 rounded-[20px] border-2 border-amber-400 bg-white shadow-md grid grid-cols-1 sm:grid-cols-[1fr_2.5fr_1fr] items-center gap-4 ${className}`}>
 {/* Left: Logo */}
 ...
 <div className="flex items-center gap-1.5 bg-white border border-gray-200 rounded-full px-3 py-2 shadow-sm whitespace-nowrap">
 ...
 <span className="text-xs md:text-sm font-bold text-gray-800 tracking-wide whitespace-nowrap">+91 9922352666</span>
 </div>
 </div>
 </div>
 );
