...
const STANDARD_GRID = [
 ...
 { num: 9, element: 'Fire', bgClass: 'bg-red-500 text-gray-900 border-red-600' },
 { num: 2, element: 'Earth', bgClass: 'bg-emerald-700 text-gray-900 border-emerald-800' }
 ],
 [
 { num: 3, element: 'Wood', bgClass: 'bg-[#fef3c7] text-[#78350f] border-[#fde68a]' },
 { num: 5, element: 'Earth', bgClass: 'bg-emerald-700 text-gray-900 border-emerald-800' },
 { num: 7, element: 'White Metal', bgClass: 'bg-white text-neutral-900 border-neutral-300' }
 ],
 [
 { num: 8, element: 'Earth', bgClass: 'bg-emerald-700 text-gray-900 border-emerald-800' },
 { num: 1, element: 'Water', bgClass: 'bg-[#1e3a8a] text-gray-900 border-[#172554]' },
...
export function LoShuGrid({ dateOfBirthStr }: LoShuGridProps) {
 ...
 <h3 className="text-2xl font-serif font-bold text-neutral-900 flex items-center justify-center gap-2">
 ...
 <div className="bg-transparent text-center space-y-3 p-2">
 <h4 className="font-bold text-base text-amber-800 flex items-center justify-center gap-1.5">
