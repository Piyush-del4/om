...
export function AstrologyChartWidget() {
 ...
 <GoldCard className="border border-[var(--gold-300)] p-6 flex flex-col space-y-4 shadow-[0_4px_30px_rgba(204,143,51,0.06)] relative min-h-[460px]">
 {/* Header Console tabs */}
 ...
 className="relative w-full h-[230px] bg-gray-50/70 border border-neutral-850 rounded-2xl overflow-hidden cursor-crosshair"
 >
 ...
 {hoveredGraha !== null ? (
 <>
 <h4 className="font-serif text-sm font-bold text-gray-900 uppercase tracking-wide flex justify-center items-center gap-1.5">
 {GRAHAS_DB[hoveredGraha].name} · <span className="text-[var(--gold)] font-sans text-xs">{GRAHAS_DB[hoveredGraha].sign}</span>
 </h4>
 <p className="text-[9px] text-gray-600 leading-normal font-light">
