...
export function AllToolsGrid() {
 ...
 <div className="group relative bg-white border border-neutral-200 hover:border-[var(--gold)]/60 rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between h-full hover:-translate-y-1">
 ...
 <span className="text-[10px] uppercase font-bold tracking-wider px-2.5 py-1 rounded-full bg-amber-500/10 text-amber-800 border border-amber-500/20">
 {tool.badge}
 </span>
 </div>

 <h3 className="font-serif font-bold text-lg text-neutral-900 group-hover:text-[var(--gold)] transition-colors">
 {tool.name}
 </h3>
