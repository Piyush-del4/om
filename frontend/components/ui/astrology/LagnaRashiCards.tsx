...
export function LagnaRashiCards({ data }: Props) {
 ...
 {/* 1. Lagna Card */}
 <div className="bg-white rounded-3xl p-3 flex flex-col items-center justify-center text-center space-y-3 transition-all duration-300">
 ...
 <h4 className="font-sans font-black text-xl md:text-2xl text-amber-950 pb-2">
 {lagnaName} Lagna
 </h4>
 </div>
