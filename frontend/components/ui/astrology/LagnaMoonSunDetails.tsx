  ...
  return (
    <div className="w-full max-w-5xl mx-auto my-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-amber-50/70 dark:bg-neutral-900 border-2 border-amber-800/30 rounded-2xl p-5 shadow-md flex flex-col justify-between space-y-4">
          <div className="border-b border-amber-800/20 pb-3 flex items-center gap-2">
            <span className="text-2xl">🌅</span>
            <div>
              <h4 className="font-serif font-bold text-amber-950 dark:text-amber-300 text-lg">
                Lagna (Ascendant)
              </h4>
          ...
          <div className="space-y-3 text-xs md:text-sm">
            <div className="flex justify-between items-center bg-white dark:bg-neutral-800 p-2.5 rounded-lg">
              <span className="text-gray-500">Ascendant Sign:</span>
              <span className="font-bold text-amber-950 dark:text-amber-300">{ascSignName}</span>
            </div>
            ...
            <div className="flex justify-between items-center bg-white dark:bg-neutral-800 p-2.5 rounded-lg">
              ...
              <span className="font-bold text-amber-900 dark:text-amber-400">{ascLord}</span>
            </div>

            <div className="p-3 bg-amber-100/60 dark:bg-neutral-800 rounded-lg space-y-1">
              <span className="font-bold text-amber-950 dark:text-amber-300 block">Personality Analysis</span>
        ...
        <div className="bg-blue-50/70 dark:bg-neutral-900 border-2 border-blue-800/30 rounded-2xl p-5 shadow-md flex flex-col justify-between space-y-4">
          <div className="border-b border-blue-800/20 pb-3 flex items-center gap-2">
            <span className="text-2xl">🌙</span>
            <div>
              <h4 className="font-serif font-bold text-blue-950 dark:text-blue-300 text-lg">
                Moon Details
              </h4>
          ...
          <div className="space-y-3 text-xs md:text-sm">
            <div className="flex justify-between items-center bg-white dark:bg-neutral-800 p-2.5 rounded-lg">
              ...
              <span className="font-bold text-blue-950 dark:text-blue-300">{moonSignName}</span>
            </div>
            ...
            <div className="flex justify-between items-center bg-white dark:bg-neutral-800 p-2.5 rounded-lg">
              ...
              <span className="font-bold text-blue-900 dark:text-blue-400">{moonNak.lord}</span>
            </div>

            <div className="p-3 bg-blue-100/60 dark:bg-neutral-800 rounded-lg space-y-1">
              <span className="font-bold text-blue-950 dark:text-blue-300 block">Emotional Traits</span>
              <p className="text-gray-700 dark:text-gray-300 text-xs">
        ...
        <div className="bg-orange-50/70 dark:bg-neutral-900 border-2 border-orange-800/30 rounded-2xl p-5 shadow-md flex flex-col justify-between space-y-4">
          <div className="border-b border-orange-800/20 pb-3 flex items-center gap-2">
            <span className="text-2xl">☀️</span>
            <div>
              <h4 className="font-serif font-bold text-orange-950 dark:text-orange-300 text-lg">
                Sun Details
              </h4>
          ...
          <div className="space-y-3 text-xs md:text-sm">
            <div className="flex justify-between items-center bg-white dark:bg-neutral-800 p-2.5 rounded-lg">
              ...
              <span className="font-bold text-orange-950 dark:text-orange-300">{sunSignName}</span>
            </div>

            <div className="flex justify-between items-center bg-white dark:bg-neutral-800 p-2.5 rounded-lg">
              <span className="text-gray-500">Solar Strength:</span>
              <span className="font-bold text-emerald-700 dark:text-emerald-400">Strong (Royal)</span>
            </div>

            <div className="flex justify-between items-center bg-white dark:bg-neutral-800 p-2.5 rounded-lg">
              <span className="text-gray-500">Career Indicator:</span>
              <span className="font-bold text-orange-900 dark:text-orange-400">Executive / Authority</span>
            </div>

            <div className="p-3 bg-orange-100/60 dark:bg-neutral-800 rounded-lg space-y-1">
              <span className="font-bold text-orange-950 dark:text-orange-300 block">Ego & Leadership</span>
              <p className="text-gray-700 dark:text-gray-300 text-xs">
