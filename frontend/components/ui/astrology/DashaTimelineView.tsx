 ...
 */
 ...
 return (
 <div className="bg-white rounded-2xl p-6 w-full max-w-full mx-auto my-6 space-y-6">
 {/* Title Header */}
 <div 
 ...
 */}
 ...
 <div className="p-4 bg-amber-100/70 border-l-4 border-amber-600 rounded-r-lg space-y-2">
 ...
 <div className="bg-white rounded-xl p-5 space-y-4">
 <h4 className="font-sans font-bold text-base md:text-lg text-amber-950 border-b pb-2">
