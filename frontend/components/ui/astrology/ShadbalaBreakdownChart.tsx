 ...
 */
 ...
 <thead>
 <tr className="bg-amber-200/80 text-amber-950 font-bold border-b border-amber-300">
 ...
 return (
 <tr key={p.planet} className="hover:bg-amber-50 :bg-neutral-700/40">
 <td className="px-1.5 py-2 sm:p-2.5 font-bold text-amber-950 ">{p.planet}</td>
 ...
 <td className="px-1.5 py-2 sm:p-2.5 font-bold text-amber-900 text-xs sm:text-sm">{p.totalRupas}</td>
