...
function PredictionCard({ cat }: { cat: LifePredictionCategory }) {
 ...
 <p className="text-xs md:text-sm text-gray-700 mt-1 font-light">
 {cat.summary}
 </p>
 </div>

 <div className="space-y-2">
 <h5 className="font-bold text-amber-900 text-xs sm:text-sm">Key Astrological Insights</h5>
 ...
 <span className="font-bold text-amber-900 text-xs block">Favorable Periods & Dashas</span>
 <p className="text-xs text-gray-700 mt-1">{cat.favorablePeriods}</p>
 </div>

 <div className="p-3 bg-emerald-50 border border-emerald-200 rounded-lg">
 <span className="font-bold text-emerald-900 text-xs block">Astrological Guidance</span>
 <p className="text-xs text-emerald-950 mt-1">{cat.guidance}</p>
 </div>
 </div>
 </div>
 );
