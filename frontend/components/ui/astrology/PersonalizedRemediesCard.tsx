...
export function PersonalizedRemediesCard({ data, birthDateStr }: Props) {
 ...
 return (
 <div className="bg-white border-2 border-amber-800/30 rounded-3xl p-6 md:p-8 w-full max-w-full mx-auto my-6 shadow-xl space-y-8 text-black ">
 ...
 <div 
 key={idx} 
 className="flex items-center gap-5 p-4 md:p-5 bg-white border-2 border-amber-200/80 rounded-2xl hover:border-amber-400 :border-amber-500 transition-all duration-300 shadow-sm hover:shadow-md group animate-fadeIn"
 >
 ...
 {[
 { planet: 'सूर्य (रविवार)', icon: '☀️', sanskrit: 'ॐ घृणिः सूर्याय नमः', english: 'Om Ghrini Suryaya Namah', iconBg: 'bg-orange-100 ', border: 'border-orange-400/30', text: 'text-orange-950 ' },
 { planet: 'चन्द्र (सोमवार)', icon: '🌙', sanskrit: 'ॐ सो सोमाय नमः', english: 'Om Som Somaya Namah', iconBg: 'bg-blue-100 ', border: 'border-blue-400/30', text: 'text-blue-950 ' },
 { planet: 'मंगल (मंगलवार)', icon: '🔴', sanskrit: 'ॐ अंग अंगारकाय नमः', english: 'Om Ang Angarkaya Namah', iconBg: 'bg-red-100 ', border: 'border-red-400/30', text: 'text-red-950 ' },
 { planet: 'बुध (बुधवार)', icon: '💚', sanskrit: 'ॐ बुं बुधाय नमः', english: 'Om Bum Budhaya Namah', iconBg: 'bg-emerald-100 ', border: 'border-emerald-400/30', text: 'text-emerald-950 ' },
 { planet: 'गुरु/बृहस्पति (गुरुवार)', icon: '🟡', sanskrit: 'ॐ ब्रहम् वृहस्पतेय नमः', english: 'Om Braham Brihaspataye Namah', iconBg: 'bg-yellow-100 ', border: 'border-yellow-400/30', text: 'text-yellow-950 ' },
 { planet: 'शुक्र (शुक्रवार)', icon: '⭐', sanskrit: 'ॐ गुं शुक्राय नमः', english: 'Om Shum Shukraya Namah', iconBg: 'bg-teal-100 ', border: 'border-teal-400/30', text: 'text-teal-950 ' },
 { planet: 'शनि (शनिवार)', icon: '🪐', sanskrit: 'ॐ शं शनैश्चराय नमः', english: 'Om Shan Shanaishcharaya Namah', iconBg: 'bg-slate-100 ', border: 'border-slate-400/30', text: 'text-slate-950 ' },
 { planet: 'राहु', icon: '🌑', sanskrit: 'ॐ रां राहवे नमः', english: 'Om Ram Rahave Namah', iconBg: 'bg-purple-100 ', border: 'border-purple-400/30', text: 'text-purple-950 ' },
 { planet: 'केतु', icon: '☄️', sanskrit: 'ॐ के केतवे नमः', english: 'Om Kem Ketave Namah', iconBg: 'bg-pink-100 ', border: 'border-pink-400/30', text: 'text-pink-950 ' }
 ].map((m, idx) => (
 <div
 key={idx}
 className={`flex items-center gap-5 p-4 md:p-5 bg-white border-2 ${m.border} rounded-2xl hover:border-amber-400 :border-amber-500 transition-all duration-300 shadow-sm hover:shadow-md group`}
 >
 {/* Planet Icon Circle */}
