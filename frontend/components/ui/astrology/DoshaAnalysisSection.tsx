 ...
 */
 ...
 className="bg-rose-800 text-gray-900 p-4 rounded-xl text-center flex items-center justify-center gap-2 select-none"
 >
 ...
 {doshas.map((dosha) => {
 let sevColor = 'bg-gray-200 text-gray-800 ';
 if (dosha.severity === 'Severe') sevColor = 'bg-rose-500 text-gray-900 font-extrabold';
 ...
 <div>
 <strong className="text-amber-900 ">Rule Analysis: </strong>
 <span className="text-gray-700 ">{dosha.cancellationApplied || 'Standard Planetary Placement'}</span>
 </div>
 ...
 <strong className="text-rose-900 block text-xs font-bold">
 Traditional Remedy:
 </strong>
