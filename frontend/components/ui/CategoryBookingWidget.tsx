...
export function CategoryBookingWidget({ category, serviceName }: CategoryBookingWidgetProps) {
  ...
  return (
    <GoldCard theme="dark" className="border border-[var(--gold-300)] p-6 md:p-8 w-full max-w-2xl mx-auto">
      ...
      <form onSubmit={handleBookSubmit} className="space-y-4">
        ...
        <div className="space-y-1">
          ...
          {isLoadingTypes ? (
            <div className="h-10 bg-neutral-900 border border-[var(--gold-200)] rounded-lg animate-pulse" />
          ...
          <>
            ...
            {selectedDate && (
              <div className="space-y-2">
                ...
                {isFetchingSlots ? (
                  <p className="text-gray-400 text-[10px] animate-pulse">Calculating slot availability against Google Calendar...</p>
        ...
        <div className="space-y-1">
          ...
          <textarea
            ...
            rows={2}
            className="w-full bg-black/60 border border-[var(--gold-100)] rounded-lg py-2.5 px-4 text-white focus:outline-none focus:ring-1 focus:ring-[var(--gold)] focus:border-transparent text-xs"
          />
        </div>
