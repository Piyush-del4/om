...
export function Skeleton({ className = '', style }: SkeletonProps) {
 return (
 <div
 className={`bg-gray-100/60 rounded-lg animate-shimmer relative overflow-hidden ${className}`}
 style={style}
 />
 );
}
...
export function ProfileFormSkeleton() {
 ...
 <GoldCard className="border border-[var(--gold-100)] p-6 space-y-5">
...
export function LecturesListSkeleton() {
 ...
 <GoldCard key={i} className="border border-[var(--gold-100)] p-4 flex flex-col justify-between h-40">
 <div className="space-y-2">
...
export function CartSkeleton() {
 ...
 <GoldCard key={i} className="border border-[var(--gold-100)] p-4">
 <div className="flex items-center gap-4">
