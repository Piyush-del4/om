...
export function GoldButton({
 ...
 return (
 <button
 className={`${baseStyle} border border-[var(--gold)]/30 p-[2.5px] bg-white/40 hover:border-[var(--gold)]/60 ${widthStyle} ${nonPaddingClasses} relative overflow-hidden group`}
