...
export function GlobalPreloader() {
 ...
 className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-white text-gray-900 select-none"
 >
 ...
 className="relative z-10 p-5 rounded-full bg-white/60 border border-[var(--gold-300)] shadow-[0_0_30px_rgba(204,143,51,0.25)] flex items-center justify-center text-[var(--gold)]"
 >
 ...
 <h2 className="font-serif text-3xl font-bold text-gray-900 tracking-wider">
 ...
 <div className="w-full h-1 bg-gray-100 rounded-full overflow-hidden border border-neutral-950">
 <motion.div
 ...
 exit={{ opacity: 0, y: -5 }}
 className="text-[10px] md:text-xs text-gray-600 font-light tracking-wide italic h-4 min-h-[16px] truncate"
 >
 {statusText}
 </motion.p>
 </div>
