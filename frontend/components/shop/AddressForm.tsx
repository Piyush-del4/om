      ...
      <div className="space-y-1">
        ...
        <div className="relative">
          ...
          <input
            ...
            required
            placeholder=""
            className="w-full bg-black/60 border border-[var(--gold-100)] rounded-lg py-2.5 pl-10 pr-4 text-white focus:outline-none focus:ring-1 focus:ring-[var(--gold)] text-sm placeholder-neutral-700"
          />
        </div>
      </div>
      ...
      <div className="space-y-1">
        ...
        <div className="relative">
          <select
            ...
            onChange={handleChange}
            required
            className="w-full bg-black/60 border border-[var(--gold-100)] rounded-lg py-2.5 px-4 text-white focus:outline-none focus:ring-1 focus:ring-[var(--gold)] text-sm cursor-pointer appearance-none"
          >
