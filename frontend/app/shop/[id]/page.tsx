...
export default function ShopItemDetailPage({ params }: { params: Promise<{ id: string }> }) {
 ...
 <h2 className="font-serif text-2xl font-bold text-gray-900 mb-2">Artifact Not Found</h2>
 ...
 <Link href="/shop" className="group flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-gray-600 hover:text-[var(--gold)] transition-colors">
 ...
 className={`w-16 h-16 rounded-lg overflow-hidden border bg-gray-100 transition-all flex-shrink-0 ${
 ...
 <span className="bg-red-600 text-gray-900 font-mono text-xs font-black uppercase tracking-widest px-3 py-1 rounded-md border border-red-500/40 shadow-[0_0_12px_rgba(220,38,38,0.45)]">
 {item.specialOfferTitle}
 </span>
 )}
 </>
 ...
 className="px-3 py-1 text-gray-600 hover:text-gray-900 hover:bg-gray-200 disabled:opacity-30 transition-colors font-mono font-bold text-sm"
 >
 -
 </button>
 <span className="px-4 py-1 text-xs font-mono font-bold text-gray-900 min-w-[32px] text-center">
 ...
 <div>
 <h4 className="text-xs font-bold text-gray-900 uppercase tracking-wider font-mono">Energized Specimen</h4>
 ...
 <div>
 <h4 className="text-xs font-bold text-gray-900 uppercase tracking-wider font-mono">Usage & Guidance</h4>
