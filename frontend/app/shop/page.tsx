      ...
      <div className="max-w-7xl mx-auto space-y-12 relative z-10">
        ...
        {isLoading ? (
              ...
              return (
                ...
                >
                  <div className="block flex-grow flex flex-col">
                    {item.imageUrl && (
                      <div className="w-full h-48 bg-neutral-900 overflow-hidden relative">
                        ...
                        {isOutOfStock && (
                          <div className="absolute inset-0 bg-black/70 backdrop-blur-[1px] flex items-center justify-center z-10">
                            <span className="bg-red-600/95 text-white font-mono text-xs font-black uppercase tracking-widest px-4 py-1.5 rounded border border-red-500 shadow-md">
                              Out of Stock
                            </span>
                          </div>
                        )}
                  ...
                  <div className="p-6 pt-4 border-t border-neutral-800/60 flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="p-2 border border-neutral-800 hover:border-[var(--gold)] hover:bg-neutral-900 rounded-lg text-gray-400 hover:text-white disabled:opacity-30 disabled:hover:border-neutral-800 disabled:hover:bg-transparent transition-colors"
                        onClick={(e) => {
                          e.preventDefault();
                          e.stopPropagation();
          ...
          <div className="text-center py-24">
            ...
            <p className="text-gray-400 text-sm font-light">No products match your query.</p>
          </div>
        )}
      </div>
    </div>
