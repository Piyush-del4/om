...
export default function AboutUsPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      {/* ── Hero Section ── */}
    <section className="relative py-28 px-4 sm:px-6 overflow-hidden bg-white dark:bg-black">
      {/* Background layers */}
      <div className="absolute inset-0 bg-gradient-to-b from-black via-neutral-950 to-black z-0 hidden dark:block" />
      <div className="absolute inset-0 opacity-10 z-0 hidden dark:block"
        style={{
          ...
          >
            ...
            <div className="lg:col-span-4 lg:[direction:ltr]">
              <div className="relative group">
                ...
                <GoldCard theme="dark" flush className={`border ${member.borderColor} relative overflow-hidden bg-white`}>
            ...
            <div className="lg:col-span-8 lg:[direction:ltr] space-y-5">
              <div className="space-y-1">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="font-serif text-2xl md:text-3xl font-bold text-white">{member.name}</h2>
              ...
              <div className="flex gap-1">
                ...
                <span className="text-gray-400 text-xs ml-2 self-center">Trusted by thousands of clients worldwide</span>
              </div>
      ...
      >
        <div className="text-center space-y-3">
          ...
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-white">Why Choose OM Astrology?</h2>
          <div className="h-0.5 w-20 bg-[var(--gold)] mx-auto" />
          <p className="text-gray-400 text-sm max-w-xl mx-auto pt-1">
          ...
          {whyChooseUs.map((item, idx) => (
            ...
            >
              ...
              >
                ...
                <h3 className="font-serif text-lg font-bold text-white group-hover:text-[var(--gold)] transition-colors duration-300">
                  {item.title}
                </h3>
      ...
      >
        ...
        <h2 className="font-serif text-3xl md:text-4xl font-bold text-white relative z-10">
          Ready for Clarity &amp; Direction?
        </h2>
        <p className="text-gray-300 text-base leading-relaxed max-w-xl mx-auto relative z-10">
