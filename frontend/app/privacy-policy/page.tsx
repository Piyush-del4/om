...
export default function PrivacyPolicyPage() {
 return (
 <div className="min-h-screen bg-white text-gray-600 py-16 px-4 sm:px-6 lg:px-8">
 <div className="max-w-4xl mx-auto space-y-8 bg-gray-50 p-8 rounded-2xl border border-[var(--gold-100)]">
 <div className="text-center space-y-2">
 <Shield className="w-12 h-12 text-[var(--gold)] mx-auto" />
 <h1 className="font-serif text-3xl md:text-4xl font-bold text-gray-900 tracking-wide">Privacy Policy</h1>
 ...
 <section className="space-y-2">
 <h2 className="text-lg font-bold text-gray-900">5. Contact Information</h2>
 <p>
