        ...
        <GoldCard theme="dark" className="border border-[var(--gold-100)] p-6 space-y-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1">
              <label className="block text-xs font-semibold uppercase tracking-wider text-gray-300">Batch Title *</label>
              <input
                type="text"
                value={title}
                ...
                className="w-full bg-black/60 border border-[var(--gold-100)] rounded-lg py-2.5 px-4 text-white focus:outline-none focus:ring-1 focus:ring-[var(--gold)] text-xs"
              />
            </div>
            ...
            <div className="space-y-1">
              <label className="block text-xs font-semibold uppercase tracking-wider text-gray-300">Offer Expiry Date & Time (Optional)</label>
              <input
                type="datetime-local"
            ...
            <div className="space-y-1">
              <label className="block text-xs font-semibold uppercase tracking-wider text-gray-300">Batch Code (Access Code - Optional)</label>
              <input
                type="text"
                value={batchCode}
