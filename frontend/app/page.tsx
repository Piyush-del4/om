      ...
      >
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div className="flex justify-center md:justify-end">
            <div className="relative w-64 h-80 md:w-72 md:h-96 rounded-2xl overflow-hidden shadow-2xl shadow-amber-300/40 border-2 border-[var(--gold)]/40 hover:scale-105 transition-transform duration-500">
              <img
          ...
          <div className="space-y-6 text-center md:text-left">
            ...
            <div className="flex items-center gap-3 justify-center md:justify-start">
              ...
              <span className="text-3xl font-serif font-bold text-[var(--gold-dark)]">₹50</span>
            </div>
            ...
            <p className="text-xs text-neutral-400">One-time payment · Instant report · No subscription</p>
          </div>
        </div>
      </motion.section>
