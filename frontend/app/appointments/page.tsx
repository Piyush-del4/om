...
export default function AppointmentsPage() {
 ...
 <p className="text-gray-600 text-xs font-light">Book deep-dive personal guidance sessions directly with our master consultants.</p>
 </div>
 <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
 {loadingTeam ? (
 <p className="text-gray-600 text-sm animate-pulse font-light">Loading master guides...</p>
 ...
 <GoldCard flush className="border border-[var(--gold-100)] flex flex-col justify-between h-full hover:border-[var(--gold-300)] transition-all duration-300 group overflow-hidden">
 <div className="flex flex-col sm:flex-row h-full">
 {/* Left/Top image */}
 <div className="w-full sm:w-1/3 aspect-square sm:aspect-auto bg-gray-100 overflow-hidden relative flex items-end">
 ...
 <h3 className="font-serif text-xl font-bold text-gray-900 group-hover:text-[var(--gold)] transition-colors">{member.name}</h3>
 <p className="text-gray-600 text-[10px] uppercase font-mono tracking-wider">{member.role}</p>
 ...
 <FormattedText text={member.description} className="text-gray-600 text-xs leading-relaxed line-clamp-2 font-bold" />
 </div>
 ...
 <div className="space-y-6">
 <div className="space-y-1">
 <h2 className="font-serif text-2xl font-bold text-gray-900">Specialized Consultation Packages</h2>
 <p className="text-gray-600 text-xs font-light">Select from our mathematically-aligned planetary analysis and vibrational healing packages.</p>
 </div>
 ...
 required
 className="w-full bg-white/60 border border-[var(--gold-200)] rounded-lg py-2.5 px-3 text-gray-900 focus:outline-none focus:ring-1 focus:ring-[var(--gold)] focus:border-transparent text-xs appearance-none"
 >
 ...
 {isFetchingSlots ? (
 <p className="text-gray-600 text-xs animate-pulse font-light">Finding available slots...</p>
 ...
 <p className="text-gray-600 text-[10px] font-light leading-relaxed">Your selected slot is reserved. Create a free account or log in to complete your booking.</p>
 </div>
 </div>
 ...
 <p className="text-gray-600 text-xs font-light">Track your active schedules, meeting links, and appointment timelines.</p>
 </div>

 {loadingAppts ? (
 <p className="text-gray-600 text-sm animate-pulse font-light">Decrypting calendars...</p>
 ...
 return (
 <GoldCard key={app._id} className={`transition-all duration-300 ${isPast ? 'opacity-50 hover:opacity-80' : ''}`}>
 <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
 <div className="space-y-1">
 <h3 className="font-serif text-lg font-bold text-gray-900">{app.typeName}</h3>
 <p className="text-gray-600 text-xs flex items-center gap-1.5 font-light font-mono">
 ...
 <div className="text-center py-10 bg-gray-100/10 rounded-xl border border-neutral-900 border-dashed">
 <p className="text-gray-600 text-xs font-light">You have no booked consultations yet.</p>
 </div>
 )}
 </div>
 )}
