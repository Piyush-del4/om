  ...
  if (!appType) {
    return (
      <div className="min-h-screen bg-black flex flex-col items-center justify-center text-gray-400 px-4 text-center">
        ...
        <h2 className="font-serif text-2xl font-bold text-white mb-2">Package Not Found</h2>
      ...
      <div className="max-w-5xl mx-auto space-y-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="p-6 rounded-2xl bg-neutral-900/30 border border-neutral-800/60 space-y-6">
              <div className="flex justify-between items-center flex-wrap gap-4">
                ...
                {appType.specialOfferTitle && (
                  <span className="bg-red-600/90 text-white font-mono text-[9px] font-bold uppercase tracking-wider px-2 py-0.5 rounded border border-red-500/30">
                    {appType.specialOfferTitle}
                  </span>
                )}
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <a href="tel:+919922352666" className="w-full">
                  <button className="w-full py-2.5 text-xs flex items-center justify-center gap-2 font-bold bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors duration-300 shadow-[0_0_15px_rgba(37,99,235,0.2)]">
                ...
                <a href="https://wa.me/919922352666" target="_blank" rel="noopener noreferrer" className="w-full">
                  <button className="w-full py-2.5 text-xs flex items-center justify-center gap-2 font-bold bg-[#25d366] hover:bg-[#20ba5a] text-white rounded-lg transition-colors duration-300 shadow-[0_0_15px_rgba(37,211,102,0.2)]">
          ...
          <div className="lg:col-span-5 scroll-mt-24" ref={bookingCardRef} id="book-form">
            <GoldCard theme="dark" className="border border-[var(--gold-300)] p-6 space-y-6">
              <div className="text-center space-y-2 border-b border-neutral-800 pb-4">
                ...
                <p className="text-gray-400 text-[11px] font-light">Select a date and available time slot below to secure your consultation.</p>
              </div>
              ...
              <form onSubmit={handleBookSubmit} className="space-y-4">
                ...
                {selectedDate && (
                  <div className="space-y-2">
                    ...
                    {isFetchingSlots ? (
                      <p className="text-gray-400 text-xs animate-pulse font-light">Aligning slots...</p>
                  ...
                  <div className="space-y-3 mt-4">
                    <div className="flex items-start gap-3 bg-[var(--gold-50)] border border-[var(--gold-200)] rounded-xl p-4">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-gray-400 text-[10px] font-light leading-relaxed">Your selected time is reserved. Sign in or create a free account to complete your booking.</p>
                      </div>
                    </div>
                    <div className="grid grid-cols-2 gap-2">
