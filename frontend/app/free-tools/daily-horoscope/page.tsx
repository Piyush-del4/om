                  ...
                  return (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
                      <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 relative overflow-hidden group hover:border-[var(--gold)] transition-colors">
                        ...
                        <div className="text-3xl font-serif text-white mb-2">{sun.fullDegree ? sun.fullDegree.toFixed(2) : '-'}°</div>
                        <div className="text-gray-400 text-sm">House: <span className="text-white">{sun.house_number || '-'}</span></div>
                      </div>
                      ...
                      <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 relative overflow-hidden group hover:border-[var(--gold)] transition-colors">
                        ...
                        <div className="text-3xl font-serif text-white mb-2">{ascendant?.fullDegree ? ascendant.fullDegree.toFixed(2) : '-'}°</div>
                        <div className="text-gray-400 text-sm">Sign Index: <span className="text-white">{ascendant?.current_sign || '-'}</span></div>
                      </div>
                    </div>
                  );
                })()}
