...
export default function MuhuratCalculatorPage() {
 ...
 <div className="text-3xl font-serif text-gray-900 mb-2">{jupiter.fullDegree ? jupiter.fullDegree.toFixed(2) : '-'}°</div>
 <div className="text-gray-600 text-sm">House: <span className="text-gray-900">{jupiter.house_number || '-'}</span></div>
 <div className="text-gray-600 text-sm mt-1">Retrograde: <span className="text-gray-900">{jupiter.isRetro === 'true' ? 'Yes' : 'No'}</span></div>
 </div>
 ...
 <div className="text-3xl font-serif text-gray-900 mb-2">{venus.fullDegree ? venus.fullDegree.toFixed(2) : '-'}°</div>
 <div className="text-gray-600 text-sm">House: <span className="text-gray-900">{venus.house_number || '-'}</span></div>
 <div className="text-gray-600 text-sm mt-1">Retrograde: <span className="text-gray-900">{venus.isRetro === 'true' ? 'Yes' : 'No'}</span></div>
 </div>
 ...
 <div className="text-gray-600 text-sm mt-1">Retrograde: <span className="text-gray-900">{moon.isRetro === 'true' ? 'Yes' : 'No'}</span></div>
 </div>
 </div>
 );
 })()}
