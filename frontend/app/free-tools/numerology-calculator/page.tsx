...
export default function NumerologyCalculatorPage() {
 ...
 <div className="text-xs text-neutral-700 uppercase tracking-wider font-bold">Mulank</div>
 </div>
 <div className="bg-white border border-neutral-200 rounded-xl p-4 text-center shadow-sm">
 <div className="text-[var(--gold)] font-serif text-3xl font-bold mb-1">{resultData?.bhagyank}</div>
 <div className="text-xs text-neutral-700 uppercase tracking-wider font-semibold">Bhagyank</div>
 </div>
 <div className="bg-white border border-neutral-200 rounded-xl p-4 text-center shadow-sm">
 <div className="text-[var(--gold)] font-serif text-3xl font-bold mb-1">{resultData?.namank}</div>
 <div className="text-xs text-neutral-700 uppercase tracking-wider font-semibold">Namank</div>
 </div>
 <div className="bg-white border border-gray-200 rounded-xl p-4 text-center shadow-sm">
 <div className="text-[var(--gold)] font-serif text-3xl font-bold mb-1">{resultData?.soulUrge}</div>
 <div className="text-xs text-neutral-700 uppercase tracking-wider font-semibold">Soul Urge</div>
 </div>
 </div>
