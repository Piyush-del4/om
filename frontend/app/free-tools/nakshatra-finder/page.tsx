                  ...
                  return (
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
                      <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 relative overflow-hidden group hover:border-[var(--gold)] transition-colors">
                        ...
                        <div className="text-3xl font-serif text-white">{nakshatra?.name}</div>
                      </div>
                      
                      <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 relative overflow-hidden group hover:border-[var(--gold)] transition-colors">
                        <div className="text-[var(--gold)] text-xs uppercase tracking-wider mb-2 font-semibold">Ruling Planet (Lord)</div>
                        <div className="text-3xl font-serif text-white">{nakshatra?.lord}</div>
                      </div>
                      
                      <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 relative overflow-hidden group hover:border-[var(--gold)] transition-colors">
                        <div className="text-[var(--gold)] text-xs uppercase tracking-wider mb-2 font-semibold">Symbol</div>
                        <div className="text-2xl font-serif text-white mt-1">{nakshatra?.symbol}</div>
                      </div>
                    </div>
                  );
                })()}
