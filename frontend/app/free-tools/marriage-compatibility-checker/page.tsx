        ...
        <GoldCard theme="dark" className="border border-[var(--gold-200)] p-6 md:p-8">
          {!result ? (
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 divide-y md:divide-y-0 md:divide-x divide-neutral-800">
                {/* Male Details */}
                <div className="space-y-6 pt-6 md:pt-0">
                  ...
                  <div className="space-y-2">
                    ...
                    <input 
                      type="text" required
                      className="w-full bg-neutral-900 border border-neutral-800 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[var(--gold)]"
                  ...
                  <div className="space-y-2">
                    ...
                    <input 
                      type="date" required
                      className="w-full bg-neutral-900 border border-neutral-800 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[var(--gold)] [color-scheme:dark]"
            ...
            >
              ...
              <div>
                <h3 className="text-2xl font-serif font-bold text-white mb-2">Match Report Generated!</h3>
                ...
                {(() => {
                  ...
                  return (
                    <div className="max-w-4xl mx-auto space-y-8">
                      {/* Big Score Card */}
                      <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-8 flex flex-col items-center justify-center relative overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-b from-[var(--gold)]/5 to-transparent pointer-events-none" />
                        <div className="text-gray-400 font-medium tracking-widest uppercase text-sm mb-4">Total Guna Milan Score</div>
                        <div className="flex items-baseline gap-2 mb-2">
                          <span className="text-7xl font-serif text-white">{score}</span>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {kootas.map((koota) => {
                          ...
                          return (
                            <div key={koota.name} className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-4 flex flex-col items-center justify-center">
                              <div className="text-gray-400 text-xs uppercase tracking-wider mb-2 text-center">{koota.name}</div>
                              <div className="text-2xl font-serif text-white">
                                <span className={kData.score === kData.out_of ? 'text-[var(--gold)]' : (kData.score === 0 ? 'text-red-400' : 'text-white')}>
                                  {kData.score}
                                </span>
