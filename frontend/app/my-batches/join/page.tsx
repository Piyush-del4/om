...
export default function JoinBatchPage() {
 ...
 <Link 
 href="/my-batches" 
 className="group flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-gray-600 hover:text-[var(--gold)] transition-colors mb-2"
 >
 ...
 <h3 className="font-sans text-[28px] font-bold text-gray-900 transition-colors group-hover:text-[var(--gold)] line-clamp-1">
 {batch.title}
 </h3>
 
 <FormattedText text={batch.description} className="text-gray-600 text-xs leading-relaxed font-light line-clamp-3" />
 </div>
 </Link>
 ...
 <div className="text-center py-24 bg-gray-50/10 border border-dashed border-gray-200 rounded-2xl">
 <GraduationCap className="w-12 h-12 mx-auto mb-4 text-gray-600 animate-bounce" />
 <p className="text-gray-600 text-sm font-light">No study batches match your query.</p>
 </div>
 )}
