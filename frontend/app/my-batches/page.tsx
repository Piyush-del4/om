...
export default function MyBatchesPage() {
  ...
  return (
    <div className="relative radial-mesh-bg min-h-screen bg-black overflow-hidden py-24 px-4 sm:px-6 lg:px-8 text-white flex items-center justify-center">
      <div className="max-w-md mx-auto py-16 text-center relative z-10">
        <div className="double-bezel-outer p-1 bg-neutral-950/20 max-w-sm mx-auto">
          <div className="double-bezel-inner py-12 px-6 flex flex-col items-center">
            ...
            <h3 className="font-serif text-xl font-bold text-white mb-2">Welcome to the Academy</h3>
            <p className="text-gray-400 text-xs font-light leading-relaxed max-w-xs mb-8">
