      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            <span className="absolute left-0 top-1/2 -translate-y-1/2 flex items-center text-gray-400">
            ...
            <input
              ...
              {...register('email')}
              className="w-full input-underline text-white text-sm py-2.5 auth-input placeholder-neutral-700"
            />
          </div>
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="••••••••"
              {...register('password')}
              className="w-full input-underline text-white text-sm py-2.5 auth-input auth-input-right placeholder-neutral-700"
            />
            <button
              type="button"
              onClick={() => setShowPassword(!showPassword)}
              className="absolute right-0 top-1/2 -translate-y-1/2 flex items-center text-gray-400 hover:text-[var(--gold)] focus:outline-none"
            >
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                {...register('name')}
                className="w-full input-underline text-white text-sm py-2 auth-input placeholder-neutral-700"
              />
            </div>
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                {...register('password')}
                className="w-full input-underline text-white text-sm py-2 auth-input auth-input-right placeholder-neutral-700"
              />
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
        ...
        <div className="space-y-6 animate-fade-in">
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full input-underline text-white text-sm py-2.5 auth-input placeholder-neutral-700 tracking-[0.5em] font-mono text-center"
              />
            </div>
          ...
          <div className="pt-4 flex flex-col gap-3">
            ...
            <button
              ...
              className="text-xs text-gray-400 hover:text-[var(--gold)] transition-colors mt-2"
            >
...
export function AuthPortal({ defaultMode = 'login' }: { defaultMode?: 'login' | 'register' }) {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col md:flex-row overflow-hidden relative">
      ...
      <div className="hidden md:flex md:w-1/2 bg-black border-r border-[var(--gold-200)]/15 relative flex-col items-center justify-center p-12 overflow-hidden select-none">
        ...
        <div className="relative w-80 h-80 md:w-96 md:h-96 flex items-center justify-center animate-float">
          ...
          <div className="absolute w-24 h-24 rounded-full bg-black/75 border border-[var(--gold-200)]/40 flex items-center justify-center animate-pulse-glow z-10">
        ...
        <div className="text-center max-w-sm mt-10 space-y-3 relative h-28 flex flex-col justify-start">
          <h2 className="font-serif text-2xl md:text-3xl font-semibold tracking-wide text-white transition-opacity duration-300">
            {mode === 'login' ? quotes.login.title : quotes.register.title}
          </h2>
          <p className="text-gray-400 text-xs font-light leading-relaxed px-4 transition-opacity duration-300">
      ...
      <div className="w-full md:w-1/2 min-h-screen radial-mesh-bg flex flex-col justify-center items-center py-16 px-4 sm:px-12 relative overflow-y-auto">
        ...
        <div className="absolute top-6 right-6 z-20">
          <Link href="/" className="text-xs text-gray-400 hover:text-[var(--gold)] font-mono transition-colors">
            ← Back to Home
          </Link>
        </div>

        {/* Premium Auth Portal Card */}
        <GoldCard theme="dark" className="w-full max-w-md relative z-10 transition-all duration-300">
          {/* Custom Tab Switcher */}
          <div className="flex border border-[var(--gold-200)]/30 p-1 rounded-full bg-neutral-950/60 max-w-[280px] mx-auto mb-8">
            <button
              type="button"
