...
export default function NameCorrectionPage() {
 ...
 <GoldCard className="w-full p-6 space-y-4">
 ...
 <h4 className="font-serif font-bold text-sm text-gray-900">{step.title}</h4>
 <p className="text-xs text-gray-600 leading-relaxed font-light">{step.desc}</p>
 </div>
 </GoldCard>
 ))}
 </div>
