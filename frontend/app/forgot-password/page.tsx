...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center px-4 py-12 bg-black text-white relative">
      <div className="absolute w-72 h-72 rounded-full bg-[var(--gold-50)] blur-3xl pointer-events-none opacity-40"></div>

      <GoldCard theme="dark" className="w-full max-w-md border border-[var(--gold-200)] relative z-10 p-8 space-y-6">
        <div className="text-center space-y-2">
          <h1 className="font-serif text-3xl font-bold tracking-wide text-white">Reset Password</h1>
        ...
        {step === 1 ? (
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-black/60 border border-[var(--gold-100)] rounded-lg py-2.5 pl-10 pr-4 text-white focus:outline-none focus:ring-1 focus:ring-[var(--gold)] focus:border-transparent text-sm placeholder-gray-600"
                />
              </div>
          ...
          <form onSubmit={resetForm.handleSubmit(handleResetPassword)} className="space-y-4" autoComplete="off">
            ...
            {/* OTP Code */}
            <div className="space-y-1">
              <label className="block text-xs font-semibold uppercase tracking-wider text-gray-300">6-Digit OTP Code</label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-400">
                ...
                <input
                  ...
                  className="w-full bg-black/60 border border-[var(--gold-100)] rounded-lg py-2.5 pl-10 pr-4 text-white focus:outline-none focus:ring-1 focus:ring-[var(--gold)] focus:border-transparent text-sm placeholder-gray-600 font-mono tracking-widest text-center"
                />
              </div>
            ...
            {/* New Password */}
            <div className="space-y-1">
              <label className="block text-xs font-semibold uppercase tracking-wider text-gray-300">New Password</label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-400">
            ...
            <div className="space-y-1">
              <label className="block text-xs font-semibold uppercase tracking-wider text-gray-300">Confirm Password</label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-400">
                  <Lock className="w-4 h-4" />
                </span>
        ...
        <div className="text-center text-xs text-gray-400 pt-2 border-t border-neutral-900">
