...
replacements = [
    ("FEAN Method (Five Elements, Astrology & Numerology)", "FEAN Method Astrology (Five Elements, Astrology & Numerology)")
]
    ...
    try:
        ...
        for old, new in replacements:
            if old in new_content:
                # To prevent double replacement if they already have "Astrology" in it
                if new in new_content:
                     # It's safer to just do a naive replace if it's EXACTLY matching `old`
                     pass
