...
replacements = [
    ("OM Astrology AMC Private Limited", "OM Astrology AMC"),
    ("OM Astrology AMC Pvt. Ltd.", "OM Astrology AMC"),  # Just in case this variation exists
    ("OM Astrology AMC Pvt Ltd", "OM Astrology AMC")
]
